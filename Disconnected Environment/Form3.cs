...
namespace Disconnected_Environment
{
    ...
    {
        private string stringConnection = "data source=LAPTOP-A8KDLC9E;" + "database=activity6;User ID=sa;Password=123";
        ...
        private void FormDataMahasiswa_Load()
        {
            ...
            this.textBox1.DataBindings.Add(new Binding("Text", this.customersBindingSource, "NIM", true));
            this.textBox2.DataBindings.Add(new Binding("Text", this.customersBindingSource, "nama_mahasiswa", true));
            this.textBox3.DataBindings.Add(new Binding("Text", this.customersBindingSource, "alamat", true));
            this.comboBox1.DataBindings.Add(new Binding("Text", this.customersBindingSource, "jenis_kel", true));
        ...
        {
            koneksi.Open();
            string str = "select jenis_kel from dbo.mahasiswa";
            SqlCommand cmd = new SqlCommand(str, koneksi);
            SqlDataAdapter da = new SqlDataAdapter(str, koneksi);
            DataSet ds = new DataSet();
            da.Fill(ds);
            cmd.ExecuteReader();
            koneksi.Close();
            comboBox1.DisplayMember = "jenis_kel";
            comboBox1.ValueMember = "jenis_kel";
